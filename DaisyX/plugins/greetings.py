...
@app.on_message(command("captcha") & ~filters.private)
...
@app.on_message(command("set_welcome") & ~filters.private)
...
@app.on_message(command("del_welcome") & ~filters.private)
...
@app.on_message(command("get_welcome") & ~filters.private)
