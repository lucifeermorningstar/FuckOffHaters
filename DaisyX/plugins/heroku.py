...
from DaisyX import SkemX, command, Config
...
@SkemX.on_message(command(["set","get","del"]) & filters.me) 
...
@SkemX.on_message(command("usage") & filters.me) 
...
@SkemX.on_message(command("logs") & filters.me) 
async def _(dyno):        
        try:
