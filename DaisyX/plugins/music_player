...
from DaisyX import SkemX as Friday, command 
...
@Friday.on_message(command("playlist") & filters.me) 
...
@Friday.on_message(command("skip") & filters.me) 
...
@Friday.on_message(command("play") & filters.me) 
...
@Friday.on_message(command("pause") & filters.me) 
...
@Friday.on_message(command("resume") & filters.me) 
...
@Friday.on_message(command("stopvc") & filters.me) 
...
@Friday.on_message(command("rvc) & filters.me) 
...
@Friday.on_message(command("rjvc") & filters.me) 
...
@Friday.on_message(command("leavevc") & filters.me) 
...
@Friday.on_message(command("setvolvc") & filters.me) 
